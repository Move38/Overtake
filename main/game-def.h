    ...
    */
    ...
    #define GAME_DEF_ACTION_PLAYER_LOCKED 3
    #define GAME_DEF_ACTION_MOVE_REQUEST 4
    #define GAME_DEF_ACTION_MOVE_RESPONSE 5
    #define GAME_DEF_ACTION_PROGRESS 6
    #define GAME_DEF_ACTION_END 7
    #define GAME_DEF_ACTION_TOTAL_OWNERSHIP 8 //9 10
    #define GAME_DEF_ACTION_NOOP 11
